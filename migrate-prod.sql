...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260607150935_AddAuditLogs'
)
BEGIN
...
BEGIN
    CREATE INDEX [IX_AuditLogs_ActionType_CreatedAt] ON [AuditLogs] ([ActionType], [CreatedAt]);
END;
...
BEGIN
    CREATE INDEX [IX_AuditLogs_WorkshopId_CreatedAt] ON [AuditLogs] ([WorkshopId], [CreatedAt]);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260607150935_AddAuditLogs', N'10.0.7');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260607154401_UpdateAuditLogCreatedAtDefaultToTurkeyTime'
)
BEGIN
    ...
    FROM [sys].[default_constraints] [d]
    INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[AuditLogs]') AND [c].[name] = N'CreatedAt');
    IF @var11 IS NOT NULL EXEC(N'ALTER TABLE [AuditLogs] DROP CONSTRAINT ' + @var11 + ';');
    ALTER TABLE [AuditLogs] ADD DEFAULT (CAST(SYSUTCDATETIME() AT TIME ZONE 'UTC' AT TIME ZONE 'Turkey Standard Time' AS datetime2)) FOR [CreatedAt];
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260607154401_UpdateAuditLogCreatedAtDefaultToTurkeyTime', N'10.0.7');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260608091211_AddSupportRequests'
)
BEGIN
    CREATE TABLE [SupportRequests] (
        ...
        [RequestedUserFullName] nvarchar(150) NULL,
        [RequestedUserPhone] nvarchar(30) NULL,
        [RequestedUserEmail] nvarchar(150) NULL,
        [RequestedUserRole] int NULL,
        [AdminResponse] nvarchar(4000) NULL,
        ...
        CONSTRAINT [FK_SupportRequests_AspNetUsers_CreatedByUserId] FOREIGN KEY ([CreatedByUserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE NO ACTION,
        CONSTRAINT [FK_SupportRequests_AspNetUsers_RespondedByUserId] FOREIGN KEY ([RespondedByUserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE NO ACTION,
        CONSTRAINT [FK_SupportRequests_Workshops_WorkshopId] FOREIGN KEY ([WorkshopId]) REFERENCES [Workshops] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE INDEX [IX_SupportRequests_CreatedByUserId] ON [SupportRequests] ([CreatedByUserId]);
END;
...
BEGIN
    CREATE INDEX [IX_SupportRequests_RequestType] ON [SupportRequests] ([RequestType]);
END;
...
BEGIN
    CREATE INDEX [IX_SupportRequests_RespondedByUserId] ON [SupportRequests] ([RespondedByUserId]);
END;
...
BEGIN
    CREATE INDEX [IX_SupportRequests_WorkshopId] ON [SupportRequests] ([WorkshopId]);
END;
...
BEGIN
    CREATE INDEX [IX_SupportRequests_WorkshopId_Status_RequestType] ON [SupportRequests] ([WorkshopId], [Status], [RequestType]);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260608091211_AddSupportRequests', N'10.0.7');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260608202437_AddUserSecurityTokens'
)
BEGIN
    ALTER TABLE [AspNetUsers] ADD [LastPasswordResetAt] datetime2 NULL;
END;
...
BEGIN
    ALTER TABLE [AspNetUsers] ADD [PasswordChangedAt] datetime2 NULL;
END;
...
BEGIN
    CREATE TABLE [UserSecurityTokens] (
        ...
        CONSTRAINT [FK_UserSecurityTokens_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE UNIQUE INDEX [IX_UserSecurityTokens_TokenHash] ON [UserSecurityTokens] ([TokenHash]);
END;
...
BEGIN
    CREATE INDEX [IX_UserSecurityTokens_UserId_Purpose_UsedAt_RevokedAt_ExpiresAt] ON [UserSecurityTokens] ([UserId], [Purpose], [UsedAt], [RevokedAt], [ExpiresAt]);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260608202437_AddUserSecurityTokens', N'10.0.7');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260609083133_AddCodeHashToUserSecurityTokens'
)
BEGIN
    ALTER TABLE [UserSecurityTokens] ADD [CodeHash] nvarchar(128) NULL;
END;
...
BEGIN
    CREATE INDEX [IX_UserSecurityTokens_CodeHash] ON [UserSecurityTokens] ([CodeHash]);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260609083133_AddCodeHashToUserSecurityTokens', N'10.0.7');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260609192440_AddSoftDeleteToServiceRequestItemsAndOperations'
)
BEGIN
    ALTER TABLE [ServiceRequestItems] ADD [DeletedAt] datetime2 NULL;
END;
...
BEGIN
    ALTER TABLE [ServiceRequestItems] ADD [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    ALTER TABLE [ServiceOperations] ADD [DeletedAt] datetime2 NULL;
END;
...
BEGIN
    ALTER TABLE [ServiceOperations] ADD [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260609192440_AddSoftDeleteToServiceRequestItemsAndOperations', N'10.0.7');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260611071752_AddFuelLevelToServiceRecords'
)
BEGIN
    ALTER TABLE [ServiceRecords] ADD [FuelLevelSnapshot] int NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260611071752_AddFuelLevelToServiceRecords', N'10.0.7');
END;
