...
namespace AutoStock.WEB.Models.Customers
{
    public class CustomerDetailViewModel
    {
        ...
        public List<CustomerVehicleSummaryViewModel> Vehicles { get; set; } = new();
        public List<CustomerServiceRecordSummaryViewModel> RecentServiceRecords { get; set; } = new();
        public List<CustomerInvoiceSummaryViewModel> RecentInvoices { get; set; } = new();
        public List<CustomerCurrentAccountSummaryViewModel> RecentCurrentAccountMovements { get; set; } = new();
    }

    public class CustomerVehicleSummaryViewModel
    {
        public int Id { get; set; }
    ...
    public class CustomerServiceRecordSummaryViewModel
    {
        public int Id { get; set; }
