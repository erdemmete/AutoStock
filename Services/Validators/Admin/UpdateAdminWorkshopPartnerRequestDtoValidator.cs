...
public class UpdateAdminWorkshopPartnerRequestDtoValidator : AbstractValidator<UpdateAdminWorkshopPartnerRequestDto>
{
    public UpdateAdminWorkshopPartnerRequestDtoValidator()
    {
